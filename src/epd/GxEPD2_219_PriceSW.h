...
#ifndef _GxEPD2_219_PriceSW_H_
#define _GxEPD2_219_PriceSW_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_219_PriceSW : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    // constructor
    GxEPD2_219_PriceSW(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
